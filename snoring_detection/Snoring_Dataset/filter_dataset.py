"""
This script is designed to manage audio samples in a specified folder.
This script is useful for manually reviewing and managing audio samples, allowing the user to delete unwanted samples
and keep a record of the deletions.
"""
